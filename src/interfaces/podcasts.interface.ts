...
export interface PIApiRecentEpisode
  extends Omit<PIApiEpisodeBase, 'chaptersUrl'> {
  feedTitle: string;
}
...
/** from trendingPodcats */
export interface PIApiNewTrending extends PIApiFeedBase {
  /** [Unix Epoch] Timestamp */
  newestItemPublishTime: number;
  description: string;
  image: string;
...
export namespace ApiResponse {
  ...
  export interface RecentNewTrending {
    // Este tambien va
    status: ApiResponse.NewFeedStatus;
    feeds: Array<PIApiNewTrending>;
    count: number;
    max: string;
    description: string;
  }
